...
test("mining screen shows the estimated mining value with a fail-closed placeholder", async () => {
  ...
  assert.equal(html.includes("Estimated mining value"), true, "missing estimated value label");
  assert.equal(js.includes("value.estimated_production_cost_usd_per_dom != null"), true, "renderer must guard against a missing estimate");
