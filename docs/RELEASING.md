...
- Wallet version: `0.2.3`
- Recommended tag: `wallet-v0.2.3`
...
that the clean release commit reports version `0.2.3`, then run:

```bash
git tag -a wallet-v0.2.3 -m "DOM Wallet V3 0.2.3 experimental"
git push origin wallet-v0.2.3
```
